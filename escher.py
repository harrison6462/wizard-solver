...
class ESCHERSolver(policy.Policy):
    ...
    def init_val_net(self):
        ...
        print(f"example_hist_state: {example_hist_state} example_legal_actions_mask: {example_legal_actions_mask}\n")
    ...
    def _sample_action_from_regret(self, state, player):
        ...
        if player >= len(self._example_info_state): breakpoint()
        self._example_info_state[player] = info_state
        self._example_legal_actions_mask[player] = legal_actions_mask
        print(f"info_state:{info_state} legal_actions mask: {legal_actions_mask} player: {player}\n") #!
...
if __name__ == "__main__":
    ...
    deep_cfr_solver = ESCHERSolver(
        ...
        check_exploitability_every=1, #10,
